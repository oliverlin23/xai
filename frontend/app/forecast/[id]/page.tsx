...
export default function ForecastMonitorPage() {
  ...
  const agentLogs = [...forecast.agent_logs, ...realtimeData.agentLogs]
  const factors = [...forecast.factors, ...realtimeData.factors]
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1">
          <AgentTimeline currentPhase={currentPhase} status={status} />
        </div>
