...
```python
from app.agents.superforecaster.prompts import FORECASTER_CLASSES, get_synthesis_prompt
...
The core superforecasting methodology remains the same - the class only influences _how_ evidence is weighted and interpreted, not _whether_ rigorous analysis is performed.
